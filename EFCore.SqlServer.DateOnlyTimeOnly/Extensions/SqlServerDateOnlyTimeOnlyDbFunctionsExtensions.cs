...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public static class SqlServerDateOnlyTimeOnlyDbFunctionsExtensions
    {
        ...
        public static int DateDiffMillisecond(this DbFunctions _, TimeOnly startTime, TimeOnly endTime)
           => throw new NotImplementedException($"This method is available only for consuming via LINQ for EntityFramework translation to SQL.");

        public static int? DateDiffMillisecond(this DbFunctions _, TimeOnly? startTime, TimeOnly? endTime)
            => throw new NotImplementedException($"This method is available only for consuming via LINQ for EntityFramework translation to SQL.");

        public static int DateDiffMicrosecond(this DbFunctions _, TimeOnly startTime, TimeOnly endTime)
           => throw new NotImplementedException($"This method is available only for consuming via LINQ for EntityFramework translation to SQL.");

        public static int? DateDiffMicrosecond(this DbFunctions _, TimeOnly? startTime, TimeOnly? endTime)
            => throw new NotImplementedException($"This method is available only for consuming via LINQ for EntityFramework translation to SQL.");

        public static int DateDiffNanosecond(this DbFunctions _, TimeOnly startTime, TimeOnly endTime)
           => throw new NotImplementedException($"This method is available only for consuming via LINQ for EntityFramework translation to SQL.");
