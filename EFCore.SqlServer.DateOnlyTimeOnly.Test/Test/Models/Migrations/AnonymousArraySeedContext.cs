...
{
    internal sealed class AnonymousArraySeedContext : MigrationContext<EventSchedule>
    {
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EventSchedule>().HasData(
                    new { Id = 1, StartDate = new DateOnly(2022, 12, 13), StartTime = new TimeOnly(9, 9) },
                    new { Id = 2, StartDate = new DateOnly(2022, 12, 24), StartTime = new TimeOnly(10, 10) },
                    new { Id = 3, StartDate = new DateOnly(1758, 12, 24), StartTime = new TimeOnly(11, 11) });
        }
...
namespace MyApp.Data.Migrations
{{
    [DbContext(typeof(AnonymousArraySeedContext))]
    partial class AnonymousArraySeedContextModelSnapshot : ModelSnapshot
    {{
